...
<br />
<h1>
<span style="font-size:small;color:#ff0000"><?=$p_groupname?></span>
<span style="font-size:small">のﾒﾝﾊﾞｰの中で
<br />
最も</span><span style="font-size:small;color:#FF00FF"><?=$nick?>さん</span><span style="font-size:small">と相性がいいのは</span>
<span style="font-size:medium;color:#0066FF">
<br />
<?=$p_name?></span><span style="font-size:small">です!!</span>
<br /><br />
</h1>
...
⇒<span style="font-size:x-small;color:#ff0000">他のﾒﾝﾊﾞｰとの相性を占う</span><br>
...
どうでしたか?
<br /><br />
<?=$p_groupname?>の他のﾒﾝﾊﾞｰと診断<span style="font-size:x-small;color:#FFD700"><?php $this->myemoji->mm('&#xE6FA;'); ?></span><br />
<?php
foreach($member_info as $key => $value){
	if($value['pid'] != $p_profid){
		$pid = $value['pid'];
		$base_url = base_url("confirm/mail/0/$pid");
		echo "<a href =\"$base_url\"><span style=\"fon-size:x-small;color:#0000ff\">";
		echo $value['name'];
		echo "</span></a><br />";
	}
}
?>
<!--
{foreach  from=$member_info key="key" item="member" name="member"}
{if $member.pid != $p_profid}
<a href="confirm.php?a={$a}&t={$t}&target={$member.pid}&group=&guid=ON">
<span style="font-size:x-small;color:#0000ff">{
$member.name}</span></a><br />
{
/if}
{/foreach} -->
<br />
...
<a href="<?php echo base_url('#search_star');?>i"><span style="font-size:small;color:#0066FF"><?php $this->myemoji->mm('&#xE6EC;'); ?>運命のｽﾀｰは誰?<?php $this->myemoji->mm('&#xE6EC;'); ?></span></a>
<br /><br />
<div style="text-align:center">
<!--広告02-->
...
<!--広告03-->
<div style="text-align:center">
<a href="http://preaf.jp/pa.do?s=s65138&o=31355&guid=ON"><img src="http://mo.preaf.jp/bn/o31355_1.gif" border="0"></a></div>
